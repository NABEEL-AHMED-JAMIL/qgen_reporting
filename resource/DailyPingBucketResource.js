...
const dailyPingBucketService = require('../service/DailyPingBucketService');

module.exports = {
    
    // 9/18/2019 create by nabeel ahmed==> Production Done
    dailyPingBucket: (req, res, next) => {
        ...
        dailyPingBucketService.dailyPingBucket(startDate,endDate,polygon,source,type)
            .then(resp => {
