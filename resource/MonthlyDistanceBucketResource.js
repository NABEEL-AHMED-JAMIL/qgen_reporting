...
const monthlyDistanceBucketService = require('../service/MonthlyDistanceBucketService');

module.exports = {
    
    // 9/18/2019 create by nabeel ahmed==> Production Done
    monthlyDistanceBucket: (req, res, next) => {
        ...
        monthlyDistanceBucketService.monthlyDistanceBucket(startDate,endDate,polygon,source,type)
            .then(resp => {
