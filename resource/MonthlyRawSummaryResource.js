...
const monthlyRawSummaryService = require('../service/MonthlyRawSummaryService.js');

module.exports = {
    
    // 9/18/2019 create by nabeel ahmed==> Production Done
    monthlyRawSummary: (req, res, next) => {
        ...
        monthlyRawSummaryService.monthlyRawSummary(startDate,endDate,polygon,type)
            .then(resp => {
